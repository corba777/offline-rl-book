---
layout: default
title: "Chapter 5: Implicit Q-Learning (IQL)"
lang: en
ru_url: /ru/chapter5/
prev_chapter:
  url: /en/chapter4/
...
# Chapter 5: Implicit Q-Learning (IQL)
...
**Cannot improve beyond the best actions in the dataset.** IQL's policy is a weighted average of dataset actions. It cannot discover actions better than what the behavior policy ever tried. CQL and model-based methods (Chapter 8) can in principle extrapolate — though this comes with risk.
...
The next step beyond model-free methods: learn a model of the world and use it to generate synthetic data. This allows offline RL to reason about transitions never seen in the dataset — at the cost of model error. That is the subject of Chapter 8.
