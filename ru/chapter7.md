---
layout: default
title: "Глава 7: Промышленные приложения"
lang: ru
en_url: /offline-rl-book/en/chapter7/
prev_chapter:
  url: /ru/chapter6/
...
# Глава 7: Промышленные приложения
...
В этой главе разбирается полный кейс на анонимизированном пятипеременном процессе нанесения покрытия. Цель — не ввести новые алгоритмы (всё использованное здесь разработано в главах 1–6), а показать, как они компонуются в реалистичной постановке и какие промышленно-специфичные решения возникают на пути.
