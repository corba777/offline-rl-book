---
layout: default
title: "Глава 7: Модельно-основанный Offline RL (MOPO, MOReL)"
lang: ru
en_url: /en/chapter7/
prev_chapter:
  url: /ru/chapter6/
...
# Глава 7: Модельно-основанный Offline RL (MOPO, MOReL)
...
**Для промышленных приложений**: если у вас есть физический симулятор (хотя бы приближённый), обучайте нейронный ансамбль на остатках между физической моделью и реальными данными. Этот гибридный подход часто требует значительно меньше офлайн-данных. Глава 8 развивает эту идею в полноценную методологию.
