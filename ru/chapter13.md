---
layout: default
title: "Глава 13: Заключение и перспективы"
lang: ru
en_url: /en/chapter13/
prev_chapter:
  url: /ru/chapter12/
...
permalink: "/offline-rl-book/ru/chapter13/"
---
...
- **BC уже достаточен** — безопасное улучшение над поведенческой политикой не нужно или не измеримо.
- **Награда плохо определена** — задержанная, proxy или confounded; «максимизировать return» бессмысленно.
- **Логи от одной узкой политики** — мало разнообразия действий/состояний; нечего извлекать.
- **Пространство действий недоинструментировано** — нет рычагов, которые реально управляют процессом.
- **Confounders отсутствуют в state** — причинная структура неверна.
- **Высокий риск deploy и слабый OPE** — оценки расходятся или нет покрытия для целевой политики.
- **Задача ближе к** supervised forecasting, MPC, constrained optimization, Bayesian optimization, contextual bandits или causal evaluation — не long-horizon RL по логам.
...
См. [Приложение: выбор алгоритма](/offline-rl-book/ru/appendix.html).
...
- Bharadhwaj, K., Choudhury, S., & Boots, B. (2021). *Conservative Safety Critics for Exploration.* ICLR. [arXiv:2010.14497](https://arxiv.org/abs/2010.14497).
